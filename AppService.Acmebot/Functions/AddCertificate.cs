...
namespace AppService.Acmebot.Functions
{
    public class AddCertificate : HttpFunctionBase
    {
        ...
        public async Task<IActionResult> HttpStart(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "certificate")] AddCertificateRequest request,
        ...
        public async Task<IActionResult> HttpPoll(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "certificate/{instanceId}")] HttpRequest req,
            string instanceId,
            [DurableClient] IDurableClient starter)
        {
            if (!User.Identity.IsAuthenticated)
